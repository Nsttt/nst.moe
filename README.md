...
I always wanted to have my own URL Shortener, and so this was born.

It's an small app built on Node. You just need to provide an URL for it to work,
you can also choose an specific alias for the link to have.
